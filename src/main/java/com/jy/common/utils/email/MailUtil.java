...
public class MailUtil {
	 ...
	 * @return
	 */
	public static MailConfig setConfig(String smtp, String port, String email, String emailName, String userName,
			String password) {
	 ...
	 * @return 成功返回true，失败返回false
	 */
	public static boolean sendAndCc(MailConfig mc, String toMail, String ccMail, String bccMail, String subject,
			String content) {
	 ...
	 * @throws Exception
	 */
	public static boolean sendProcess(MailConfig mc, String toMailList, String ccAdress, String bccAdress,
	...
	public static void asynSend(final MailConfig mc, MailTemplate mailTemplate, String subject) {
		if (null != mailTemplate && StringUtils.isNotBlank(subject)) {
			asynSend(mc, mailTemplate.getToMail(), mailTemplate.getCcMail(), mailTemplate.getBccMail(), subject,
	 ...
	 * @param content
	 */
	public static void asynSendAndCc(final MailConfig mc, final String toMail, final String ccMail,
	 ...
	 */
	public static void asynSendAndCc(final MailConfig mc, final String toMail, final String ccMail,
			final String bccMail, final String subject, final String content, final String... files) {
	 ...
	 */
	public static void asynSendAndCc(final MailConfig mc, final String toMail, final String ccMail,
			final String bccMail, final String subject, final String content, final List<String> files) {
	 ...
	 * @throws Exception
	 */
	public static boolean asynSend(final MailConfig mc, final String toAddress, final String ccAdress,
			final String bccAdress, final String subject, final String content, final List<String> fileList) {
