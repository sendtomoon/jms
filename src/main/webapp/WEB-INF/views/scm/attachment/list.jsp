...
<div class="page-content">
				...
				<div class="col-sm-9">
					...
					<div class="row">
						<div class="widget-main">	
							...
							&nbsp;&nbsp;<span id="selectStoreStatus"><label></label>：<select  data-placeholder="状态" name="status" class="chosen-select isSelect75"></select></span>				
					...
					<table id="baseTable" class="table table-striped table-bordered table-hover" >
						<thead>
							<tr>
								...
								<th style="width:10%" class="center">附件名称</th>
								<th style="width:15%" class="center">路径</th>
		...
		<script type="text/javascript" src="${jypath}/static/js/scm/attachment/Attachment.js"></script>
</body>
</html>