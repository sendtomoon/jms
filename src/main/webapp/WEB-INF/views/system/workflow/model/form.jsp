...
<div id="auDiv" class="hide">
		<form id="auForm" target="_blank" method="POST" action="${jypath}/backstage/workflow/model/create" >
			<table cellspacing="0" cellpadding="0" border="0" class="customTable">
				<tbody>
					...
					<tr class="FormData">
						...
						<td class="DataTD">&nbsp;
						<input type="text" jyValidate="required,ennum" role="textbox" maxlength="32" name="key" class="FormElement ui-widget-content ui-corner-all"></td>
					</tr>
					<tr class="FormData">
