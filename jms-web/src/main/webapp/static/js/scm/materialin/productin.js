...
$(function(){
	...
	JY.Dict.setSelect("selFeeType","SCM_DISCRIPTION",1);
	/*1：先填写公共的原料入库*/
			...
			if(JY.Validate.form("baseForm") && $('#materialinAdd tbody tr').length>0){
				var json_data="";
		 	    ...
		 	    $('#materialinAdd tbody tr').each(function(element,index){
		 	        var data='{"id":"'+$(this).find("input[name=id]").val()+'","enteryno":"'+$(this).find("input[name=enteryno]").val()+'","code":"'+$(this).find("input[name=code]").val()+'","num":"'+$(this).find("input[name=num]").val()+'","weight":"'+$(this).find("input[name=weight]").val()+'","feeType":"'+$(this).find("input[name=feeType]").val()+'","price":"'+$(this).find("input[name=price]").val()+'","purcost":"'+$(this).find("input[name=purcost]").val()+'","checkcost":"'+$(this).find("input[name=checkcost]").val()+'","finacost":"'+$(this).find("input[name=finacost]").val()+'","diffweight":"'+$(this).find("input[name=diffweight]").val()+'","remarks":"'+$(this).find("input[name=remarks]").val()+'"}';	
		        ...
		        json_data='['+json_data+']';
		        $.ajax({type:"POST",url:jypath+"/scm/productin/add",data: "myData="+json_data+"&warehouseid="+$('#baseForm').find("select[name=warehouseId]").val()+"&locationid="+$('#baseForm').
				   find("select[name=locationId]").val()+"&remarks="+$('#baseForm').find("textarea[name=remarksTwo]").val()+"&id="+$('#baseForm').
				   find("input[name=id]").val()+"&status="+type+"&purno="+$('#baseForm').find("input[name=purno]").val()+"&feeType="+$('#baseForm').find("select[name=feeType]").val(),dataType:"text",success:function(data,textStatus){ 
	...
	$('#addBtn').on('click', function(e) {
		e.preventDefault();
		cleanMaterialinForm();
		addInfo({id:"materialinDiv",title:"商品入库信息",height:"600",width:"400",savefn:function(e){
			var that =$(this);
			var html="";		    		
			if(JY.Validate.form("materialinForm")){
				var code=$("#materialinForm input[name$='code']").val();
				JY.Ajax.doRequest(null,jypath +'/scm/productin/findByCode',{code:code},function(data){
					 ...
					 html+="<td style='padding:1px;'><input class='center' type='text' name='code' readonly value='"+JY.Object.notEmpty(data.obj[0].code)+"' style='width:100%;height:30px;border:none;'/><input type='hidden' name='checkcost' value='0'/><input type='hidden' name='remarks' value='无'/><input type='hidden' name='feeType' value='"+JY.Object.notEmpty(data.obj[0].feeType)+"'/><input type='hidden' name='id' value='"+JY.Object.notEmpty(data.obj[0].id)+"'/></td>";
					 ...
					 html+="<td style='padding:1px;'><input class='center' type='text' name='num' onkeyup='JY.Validate.limitNum(this)'  value='"+JY.Object.notNumber(data.obj[0].num)+"'  style='width:100%;height:30px;border:none;' readonly/></td>";
					 html+="<td style='padding:1px;'><input class='center' type='text' name='weight' onkeyup='JY.Validate.limitDouble(this)' value='"+JY.Object.notNumber(data.obj[0].weight)+"' style='width:100%;height:30px;border:none;' readonly/></td>";
					...
					/* html+="<td style='padding:1px;'><input class='center' type='text' name='checkcost' onblur='commFoot()' onkeyup='JY.Validate.limitDouble(this)' value='"+$("#materialinForm input[name$='checkcost']").val()+"' style='width:100%;height:30px;border:none;'/></td>";*/
	...
	$("#findCode").typeahead({
        source: function (query, process) {
        	$.ajax({
				type:'POST',
				url:jypath+'/scm/productin/findSetCode',
				data:{code:query},
				dataType:'json',
        ...
        afterSelect: function (value) {
        	$.ajax({
        		type:'POST',
        		url:jypath+'/scm/productin/findByCode',
        		data:{code:value},
        		dataType:'json',
        		success:function(data,textStatus){
	...
	if(obj!=null){
		for(var i=0;i<obj.length;i++){ 
			...
			if(list.indexOf(obj[i].code)==-1){
				 ...
				 html+="<td style='padding:1px;'><input class='center' type='text' name='num' onkeyup='JY.Validate.limitNum(this)'  value='"+JY.Object.notNumber(obj[i].num)+"'  style='width:100%;height:30px;border:none;' readonly/></td>";
				 html+="<td style='padding:1px;'><input class='center' type='text' name='weight' onkeyup='JY.Validate.limitDouble(this)' value='"+parseFloat(JY.Object.notNumber(obj[i].weight)).toFixed(4)+"' style='width:100%;height:30px;border:none;' readonly/></td>";
				 html+="<td style='padding:1px;'><input class='center' type='text' name='diffweight' onblur='commFoot()' onkeyup='JY.Validate.limitNum(this)'  value='"+parseFloat(JY.Object.notNumber(obj[i].diffweight)).toFixed(4)+"' style='width:100%;height:30px;border:none;' readonly/></td>";
				 if(dataPrice==1){
					 html+="<td style='padding:1px;'><input class='center' type='text' name='purcost' onblur='commFoot()' onkeyup='JY.Validate.limitNum(this)'  value='"+parseFloat(JY.Object.notNumber(obj[i].purcost)).toFixed(4)+"' style='width:100%;height:30px;border:none;' readonly/></td>";
					 html+="<td style='padding:1px;'><input class='center' type='text' name='checkcost' onblur='commFoot()' onkeyup='JY.Validate.limitDouble(this)' value='"+parseFloat(JY.Object.notNumber(obj[i].checkcost)).toFixed(4)+"' style='width:100%;height:30px;border:none;' readonly/></td>";
					 html+="<td style='padding:1px;'><input class='center' type='text' name='finacost' onblur='commFoot()' onkeyup='JY.Validate.limitNum(this)'  value='"+parseFloat(JY.Object.notNumber(obj[i].finacost)).toFixed(4)+"' style='width:100%;height:30px;border:none;' readonly/></td>";
				 }
				 html+="<td style='padding:1px;'><input class='center' type='text' name='price' onblur='commFoot()' onkeyup='JY.Validate.limitDouble(this)' value='"+parseFloat(JY.Object.notNumber(obj[i].price)).toFixed(4)+"'  style='width:100%;height:30px;border:none;' readonly/></td>";
				 html+="</tr>";
			}else{
...
function commFoot(){
	 ...
	 var price=0,purcost=0,finacost=0,diffweight=0,count=0,num=0,weight=0,checkcost=0;
	 ...
	 $('#materialinAdd').find('input[name="checkcost"]').each(function(element,index){
		 if($(this).val()!=''){checkcost+=parseFloat($(this).val());}
	 });
	 ...
	 if(dataPrice==1){
		 ...
		 foot+="<td style='padding:1px;'><input class='center' type='text'  readonly  value='"+parseFloat(checkcost).toFixed(4)+"' style='width:100%;height:30px;border:none;' readonly /></td>";
...
function getbaseList(init){
	...
	JY.Model.loading();
	JY.Ajax.doRequest("materialinBaseForm",jypath +'/scm/productin/findByPage',null,function(data){
		 $("#materialinTable tbody").empty();
    		 ...
    		 if(results!=null&&results.length>0){
        		 ...
        		 for(var i = 0;i<results.length;i++){
            		 ...
            		 html+="<td class='center hidden-480'>"+JY.Object.notEmpty(l.purno)+"</td>";
            		 html+="<td class='center hidden-480'>"+JY.Object.notEmpty(l.orgName)+"</td>";
            		 html+="<td class='center hidden-480'>"+JY.Object.notNumber(l.totalcount)+"</td>";
            		 html+="<td class='center hidden-480'>"+parseFloat(JY.Object.notNumber(l.totalWeight)).toFixed(4)+"</td>";
            		 if(dataPrice==1){
	            		 html+="<td class='center hidden-480'>"+parseFloat(JY.Object.notNumber(l.purcost)).toFixed(4)+"</td>";
	            		 html+="<td class='center hidden-480'>"+parseFloat(JY.Object.notNumber(l.checkcost)).toFixed(4)+"</td>";
	            		 html+="<td class='center hidden-480'>"+parseFloat(JY.Object.notNumber(l.finacost)).toFixed(4)+"</td>";
            		 }
...
function commForm(data){
	 $("#baseForm input[id='totalNum']").val(JY.Object.notEmpty(data.obj.purenteries.totalnum));
	 $("#baseForm input[id='totalCount']").val(JY.Object.notEmpty(data.obj.purenteries.totalcount));
	 $("#baseForm input[id='totalprices']").val(JY.Object.notEmpty(data.obj.purenteries.totalprice));
	 $("#baseForm input[id='finacosts']").val(JY.Object.notEmpty(data.obj.purenteries.finacost));
	 $("#baseForm input[id='purcosts']").val(JY.Object.notEmpty(data.obj.purenteries.purcost));
	 $("#baseForm input[id='diffweights']").val(JY.Object.notEmpty(data.obj.purenteries.diffweight));
	 $("#baseForm input[id='checkcosts']").val(JY.Object.notEmpty(data.obj.purenteries.checkcost));
	 $("#baseForm select[id$='selectWarehouse']").val(JY.Object.notEmpty(data.obj.purenteries.warehouseid));
	 $("#baseForm select[id$='feeType']").val(JY.Object.notEmpty(data.obj.purenteries.feeType));
	 ...
	 $("#baseForm input[name$='enteryno']").val(JY.Object.notEmpty(data.obj.purenteries.enteryno));
	 $("#baseForm input[name$='id']").val(JY.Object.notEmpty(data.obj.purenteries.id));
	 $("#baseForm textarea[name$='remarksTwo']").val(JY.Object.notEmpty(data.obj.purenteries.remarks));
...
function view(id){
	...
	JY.Ajax.doRequest(null,jypath +'/scm/productin/view',{id:id},function(data){
		setForm(data);
...
function edit(id){
	...
	JY.Ajax.doRequest(null,jypath +'/scm/productin/view',{id:id,type:1},function(data){
		setUpdateForm(data);
		if(data.obj.purenteries.status=="4"){
			$("#baseForm #causesDiv").removeClass("hide");
		}
		baseInfo({id:"baseDiv",title:"修改入库单",height:"720",width:"1024",savefn:function(type){
			...
			if(JY.Validate.form("baseForm") && $('#materialinAdd tbody tr').length>0){
				...
				var trueFalse=1;
		 	    var last_index=$('#materialinAdd tbody tr').length-1;
		 	    $('#materialinAdd tbody tr').each(function(element,index){
				 	   var data='{"id":"'+$(this).find("input[name=id]").val()+'","enteryno":"'+$(this).find("input[name=enteryno]").val()+'","feeType":"'+$(this).find("input[name=feeType]").val()+'","type":"'+$(this).find("input[name=type]").val()+'","code":"'+$(this).find("input[name=code]").val()+'","num":"'+$(this).find("input[name=num]").val()+'","weight":"'+$(this).find("input[name=weight]").val()+'","price":"'+$(this).find("input[name=price]").val()+'","purcost":"'+$(this).find("input[name=purcost]").val()+'","checkcost":"'+$(this).find("input[name=checkcost]").val()+'","finacost":"'+$(this).find("input[name=finacost]").val()+'","diffweight":"'+$(this).find("input[name=diffweight]").val()+'","remarks":"'+$(this).find("input[name=remarks]").val()+'"}';	
				 	   if($(this).index()==last_index){
				 		   json_data+=data;
				       }else{
				    	   json_data+=data+',';
			    ...
			    json_data='['+json_data+']';
			    $.ajax({type:"POST",url:jypath+"/scm/productin/edit",data: "myData="+json_data+"&warehouseid="+$('#baseForm').find("select[name=warehouseId]").val()+"&locationid="+$('#baseForm').find("select[name=locationId]").val()+"&feeType="+$('#baseForm').find("select[name=feeType]").val()+"&remarks="+$('#baseForm').find("textarea[name=remarksTwo]").val()+"&id="+$('#baseForm').find("input[name=id]").val()+"&status="+type,dataType:"text",success:function(data,textStatus){  			        	 
				   var json_obj=eval('('+data+')');
				   if(json_obj.res==1){
		        		that.dialog("close");      
		        		JY.Model.info(json_obj.resMsg,function(){search();});
...
function check(id){
	...
	$('#baseForm').find('.caozuo').hide();
	$('#baseForm').find('.btnClass').hide();
	JY.Ajax.doRequest(null,jypath +'/scm/productin/view',{id:id,type:2},function(data){
		setForm(data);
		checkInfo({id:"baseDiv",title:"审核入库单",height:"700",width:"1024",savefn:function(checkType,checkTitle){
			...
			JY.Model.confirm(checkTitle,function(){
				...
				JY.Ajax.doRequest(null,jypath +'/scm/productin/check',{id:id,status:checkType,description:causes},function(data){
					model1.dialog("close");
					model2.dialog("close"); 
			...
			/*var that =$(this);
			JY.Model.confirm(checkTitle,function(){	
				JY.Ajax.doRequest(null,jypath +'/scm/productin/check',{id:id,status:checkType},function(data){
					JY.Model.info(data.resMsg,function(){search();});
					that.dialog("close");
				});
			});*/
...
function del(cheks){
	...
	JY.Model.confirm("确认删除吗？",function(){	
		JY.Ajax.doRequest(null,jypath +'/scm/productin/del',{cheks:cheks.toString()},function(data){
...
function print(){
	 ...
	 $("#printDiv").load(jypath +'/scm/materialin/print?id='+id+'&type='+1,function(){
		 if(LODOP){
			 LODOP=getLodop();  
