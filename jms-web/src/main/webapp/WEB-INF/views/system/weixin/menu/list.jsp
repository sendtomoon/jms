	...
	<div class="col-sm-4">
		<div class="menu_preview_area">
			<div class="mobile_menu_preview">
				<div class="mobile_hd tc">金一文化微信平台</div>
				<div class="mobile_bd">
					...
					<div>
						<form id="menuForm" class="form-horizontal" >
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" jyValidate="required" name="name" maxlength="20" class="col-xs-10 col-sm-5"   >
								</div>
							</div>
							<div class="form-group">
...
<script src="${jypath}/static/js/system/weixin/menu/menu.js"></script>
</body>
</html>