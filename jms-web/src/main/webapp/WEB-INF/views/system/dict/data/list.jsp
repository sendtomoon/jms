...
<body>
				...
				<table id="baseTable" class="table table-striped table-bordered table-hover" >
					<thead>
						<tr>
							...
							<th style="width:10%" class="center">关键字</th>
							<th style="width:15%" class="center">中文说明</th>
							<th style="width:15%" class="center hidden-480" >描述</th>
							<th style="width:5%" class="center hidden-480" >状态</th>
							<th style="width:15%" class="center hidden-480">创建时间</th>
							<th style="width:15%" class="center hidden-480">修改时间</th>
	...
	<script src="${jypath}/static/js/system/dict/dataDict.js"></script>
</body>
</html>