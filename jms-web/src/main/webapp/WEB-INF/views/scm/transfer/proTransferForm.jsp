...
<form id="transferDetailForm" method="POST" onsubmit="return false;" >
	<div class="col-xs-12">
			<table>
				<tr class="FormData">
			        ...
			        <td class="DataTD"><input type="text"  name="typeName" readonly  placeholder="移库" ><input type="hidden" name="type" value="1"/><input id="transferId" type="hidden" name="id"></td>
			        <td>&nbsp;<font color="red">*</font>拨入仓库：
						<span>
							<select  id="selectWarehouse" style="width: 120px;" name="inWarehouseId" jyValidate="required" onchange="chgWarehouseLocation($(this).val())"></select>
						</span>
					</td>
					<td>&nbsp;<font color="red">*</font>拨入仓位：
						<span>
							<select  id="selectWarehouseLocation" style="width: 120px;" name="inLocationId"  jyValidate="required"></select>
						</span>
					</td>
				</tr>
			</table>
