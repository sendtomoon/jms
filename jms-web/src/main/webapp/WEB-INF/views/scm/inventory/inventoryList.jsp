...
<body>
	<div class="page-content">
		<div class="row-fluid">
			<div class="col-xs-12">
				<div id="rightDiv" >
					<form id="InventoryForm" class="form-inline" method="POST" onsubmit="return false;">
						<div class="row">
							<div class="widget-main">	
								&nbsp;&nbsp;编号：<input type="text" name="inventoryNo"  placeholder="这里输入编号" style="width:150px;"   class="input-large">
								&nbsp;&nbsp;<span id="selCategory">货类：<select jyValidate="required"  name="categoryId" style="width:125px;"></select></span>
								&nbsp;&nbsp;<span id="selGroup">货组：<select jyValidate="required"  name="groupId" style="width:125px;"></select></span>
								&nbsp;&nbsp;<span id="selectisValid">状态：<select   data-placeholder="状态" name="status" class=" isSelect75"></select></span>	
								&nbsp;&nbsp;时间：<input type="text" id="dateBegin" name="inventoryStartDate" value="2017/1/1"/>-	<input type="text" id="dateEnd" name="inventoryEndDate" value="2017/12/31"  />
...
<script src="${jypath}/static/js/scm/inventory/inventory.js"></script>
