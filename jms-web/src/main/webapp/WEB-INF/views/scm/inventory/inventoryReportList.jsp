...
<!-- 										<button id='searchBtn' class="btn btn-warning  btn-xs" title="过滤" type="button" onclick="getbaseList(1)"><i class="icon-search bigger-110 icon-only"></i></button>									 -->
							...
							<table id="baseTable" class="table table-striped table-bordered table-hover" >
								<thead>
									<tr>
										...
										<th style="width:10%"class="center">盘点编号</th>
										<th style="width:8%" class='center'>盘点机构</th>
										<th style="width:8%" class='center'>盘点仓库</th>
										<th style="width:10%" class="center">盘点仓位</th>
			...
			<%@include file="inventoryReportForm.jsp" %>
			<%@include file="../../common/dialog.jsp" %>
			</div>
		</div>
	</div>
	
<script src="${jypath}/static/js/scm/inventory/inventoryReport.js"></script>
