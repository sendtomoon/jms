					...
					<form id="baseForm" class="form-inline" method="POST" onsubmit="return false;">
						<div class="row">
							<div class="widget-main">	
								...
								时间：<input type="text" id="dateRender1" name="arrivalDate" value="2017/1/1"/>-	<input type="text" id="dateRender2" name="arrivalDateEnd" value="2017/12/31"  />	
...
<script src="${jypath}/static/js/scm/purorder/order2.js"></script>	
