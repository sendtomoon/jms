					...
					<table id="baseTable" class="table table-striped table-bordered table-hover" >
						<thead>
							<tr>
								...
								<th style="width:5%" class="center hidden-480">拨出仓库</th>
								<th style="width:5%" class="center hidden-480">拨入单位</th>
								<th style="width:5%" class="center hidden-480">拨入仓库</th>
...
<!-- 								<th style="width:10%" class="center">操作</th> -->
			...
			<!-- #addorUpdateFrom -->
			<%@include file="orderReturnForm.jsp" %>
			<%@include file="../../common/dialog.jsp" %>
			</div>
		</div>
	</div>	
<script src="${jypath}/static/js/scm/purorder/orderReturn.js"></script>	
