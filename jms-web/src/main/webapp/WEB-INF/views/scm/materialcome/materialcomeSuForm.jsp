...
<div id="materialcomeDiv" style="overflow-y: hidden;height: auto" class="hide">
	<div class="col-xs-12">
				...
				<table id="materialcomeAdd" class="table table-striped table-bordered table-hover">
					<thead>
						<tr>
							...
							<th style="width:4%" class="center">实重</th>
	...
	<form id="materialaddForm" method="POST" onsubmit="return false;"
		...
		<table cellspacing="0" cellpadding="4px;" border="0"
			...
			<tr class="FormData">
				...
				<td class="Datatd">
				<input type="text" jyValidate="required" maxlength="16" name="count" onkeyup="JY.Validate.limitNum(this)" class="FormElement ui-widget-content ui-corner-all"></td>
			</tr>
			<tr class="FormData">
				<td class="Captiontd"><font color="red">*</font>总重：</td>
				<td class="Datatd"><input type="text" jyValidate="required" onkeyup="JY.Validate.limitAmtNum(this)" maxlength="16" name="requireWt" class="FormElement ui-widget-content ui-corner-all"></td>
			</tr>
			<tr class="FormData">
				<td class="Captiontd"><font color="red">*</font>实重：</td>
				<td class="Datatd"><input type="text" name="actualWt" onkeyup="JY.Validate.limitAmtNum(this)" jyValidate="required" class="FormElement ui-widget-content ui-corner-all"/></td>
			</tr>
			<tr class="FormData">
