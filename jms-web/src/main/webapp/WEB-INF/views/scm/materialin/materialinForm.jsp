		...
		<form id="baseForm" method="POST" onsubmit="return false;" >
			<table cellspacing="0" cellpadding="4px;" border="0" class="customTable">
				...
				<tr class="FormData">
					...
					<td class="DataTD">
						<select id="selectWarehouse" style="width: 120px;" name="warehouseId" jyValidate="required" onchange="chgWarehouseLocation($(this).val(),'selectWarehouseLocation')"></select>
					</td>
			...
			<div class="col-xs-12" style="height: 380px;overflow-y: scroll;border: 1px solid #ddd">
					...
					<thead>
						<tr>
							...
							<th style="width:4%"  class="center">采购成本</th>
							<th style="width:4%"  class="center">销售价</th>
							<!-- <th style="width:4%"  class="center">财务成本</th> -->
						</tr>
					</thead>
					<tbody></tbody>
					<tfoot></tfoot>
	...
	<form id="materialinForm" method="POST" onsubmit="return false;"  enctype="multipart/form-data">
		<table cellspacing="0" cellpadding="4px;" border="0" class="customTable">
			...
			<td class="CaptionTD"><font color="red">*</font>数量：</td>
				<td class="DataTD"><input type="number" jyValidate="required" onkeyup="JY.Validate.limitNum(this)"  maxlength="16" name="num"  min="1"  class="FormElement ui-widget-content ui-corner-all" value="1"></td>
			</tr>
			<tr class="FormData">
				<td class="CaptionTD">
					<font color="red">*</font>重量：</td>
				<td class="DataTD"><input type="text" jyValidate="required" maxlength="16" name="weight" class="FormElement ui-widget-content ui-corner-all" onkeyup="JY.Validate.limitDouble(this)">
				</td>
			</tr>
			<tr class="FormData">
				<td class="CaptionTD">
