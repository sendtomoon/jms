	...
	<div class="page-content">
		<div class="row-fluid">
			<div class="col-xs-12">
				<div id="rightDiv" >
					<form id="materialinBaseForm" class="form-inline" method="POST" onsubmit="return false;">
						<div class="widget-main customBtn">	
							<table>
									<tr>
										<td><span>入库单号：<input type="text"  name="enteryno" placeholder="输入入库单号" class="input-large" style="width: 150px;"></span>&nbsp;&nbsp;</td>
										<td><span>订单单号：<input  type="text"  name="purno" placeholder="输入订单单号" class="input-large" style="width: 150px;"></span>&nbsp;&nbsp;</td>
					...
					<table id="materialinTable" class="table table-striped table-bordered table-hover" >
						<thead>
							<tr>
								...
								<th style="width:10%" class="center">订单单号</th>
								<th style="width:8%" class='center'>单位名称</th>	
								<th style="width:6%" class="center">数量</th>
								<th style="width:6%" class="center">重量</th>	
								<th style="width:6%"  class='center hidePrice' >采购成本</th>
								<th style="width:6%" class="center hidePrice">核价成本</th>
								<th style="width:6%" class="center hidePrice">财务成本</th>
								<th style="width:6%" class="center">牌价合计</th>
								<!-- <th style="width:6%" class="center">入库数量总计</th> -->
								<th style="width:8%" class="center">状态</th>
								<th style="width:12%" class="center">入库时间</th>
							</tr>
						</thead>
						<tbody></tbody>
					</table>  
				...
				<%@include file="../materialin/productinForm.jsp" %>
			</div>
		</div>
	</div>
<script src="${jypath}/static/js/scm/materialin/productin.js"></script>
</body>