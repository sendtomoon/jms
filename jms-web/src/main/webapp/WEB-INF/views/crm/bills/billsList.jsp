...
<body>
	...
	<div class="page-content">
		<div class="row-fluid">
			<div class="col-xs-12">
				<div id="rightDiv" >
					<form id="billsBaseForm" class="form-inline" method="POST" onsubmit="return false;">
						<div class="widget-main customBtn">	
							<input name="orgId" type="hidden"/>
							<span>会员号：</span><input  type="text"  name="cardNo" placeholder="请输入关键词" style="width:150px;">&nbsp;&nbsp;
							<span>销售单号：</span><input  type="text"  name="orderNo" placeholder="请输入关键词" style="width:150px;">&nbsp;&nbsp;
							<span id="selectBillsStatus">状态：<select  data-placeholder="状态" name="status" class="isSelect75"></select></span>&nbsp;&nbsp;
					...
					<table id="billsTable" class="table table-striped table-bordered table-hover" >
						<thead>
							<tr>
								...
								<th style="width:6%" class="center">金额</th>
								<th style="width:5%" class="center">支付积分</th>
								<th style="width:6%" class="center">获得积分</th>
				...
				<%@include file="../bills/billsForm.jsp" %>
			</div>
		</div>
	</div>
<script src="${jypath}/static/js/system/jy/jy.component.js"></script>
<script src="${jypath}/static/js/crm/bills/bills.js"></script>
